...
export class TransactionsApi {
     ...
     * @param options Override http request option.
     */
    public async listRecentAddresses(wallet_uuid: string, limit?: number, token_id?: string, X_API_Key?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<StandardResponseListRecentAddressRead>> {
     ...
     * @param options Override http request option.
     */
    public async listRecentAddressesByUser(limit?: number, token_id?: string, X_API_Key?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<StandardResponseListRecentAddressRead>> {
        let localVarPath = '/api/v1/wallets/recent-addresses';
        const localVarUrlObj = new URL(localVarPath, this.basePath);
        const localVarRequestOptions: AxiosRequestConfig = { method: 'GET', ...options };
        const localVarHeaderParameter: Record<string, string> = { ...this.getHeaders() };
        const localVarQueryParameter: Record<string, any> = {};
