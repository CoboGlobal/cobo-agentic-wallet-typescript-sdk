...
export class TransactionsApi {
     ...
     * @param options Override http request option.
     */
    public async listRecentAddressesByUser(limit?: number, X_API_Key?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<StandardResponseListRecentAddressRead>> {
